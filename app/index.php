...
<div class="fs-wrapper">
    ...
    <div class="fs-wrapper__bg-lt"></div>
    <div class="fs-wrapper__bg-rt"></div>
    <div class="fs-wrapper__bg-rb"></div>
    <div class="fs-wrapper__bg-lb"></div>
    ...
    <div data-page="main" class="js-page_switch js-page_switch--active js-page_switch fs-wrapper__inner-wrapper">
        <div id="parallax" class="parallax js-parralex">
            ...
            <a data-depth="0.2" class="btn-1 btn-1--mix-blend parallax__floater parallax__floater--contact fs-40"  alt="">
            ...
            <a data-depth="0.4" class="btn-1 btn-1--mix-blend parallax__floater parallax__floater--github fs-40"  alt="">
                <div class="btn-1__text-wrapper">
                    This project
                </div>
            </a>
